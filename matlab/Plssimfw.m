% Attention 1e7 remplace 1e5 dans les tests

%############################################################################
%# function [T,P,U,C,B,R,R2X,R2Y]=plssimfw(X,Y,A,S,XtX)                     #
%#                                                                          #
...
function [B,T,U,C,P,R,R2X,R2Y]=plssimfw(X,Y,A,S,XtX);
